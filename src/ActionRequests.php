...
class ActionRequests
{
    ...
    public $permissions = array(
        ...
        'transfer_wpdb_live' => array('label' => 'From live',
            'condition' => array('transfer', 'transfer_wp_db')),

        'transfer_wpdb_live_to_staging' => array('label' => 'to staging server',
            'condition' => array('transfer', 'transfer_wp_db', 'transfer_wpdb_live')),
        'transfer_wpdb_live_to_staging_db' => array('label' => 'Transfer DB',
            'condition' => array('transfer', 'transfer_wp_db', 'transfer_wpdb_live', 'transfer_wpdb_live_to_staging')),
        'transfer_wpdb_live_to_staging_replace_urls' => array('label' => 'Search-Replace DB URLs',
            'condition' => array('transfer', 'transfer_wp_db', 'transfer_wpdb_live', 'transfer_wpdb_live_to_staging')),
        'transfer_wpdb_live_to_staging_options' => array('label' => 'Set custom DB options',
            'condition' => array('transfer', 'transfer_wp_db', 'transfer_wpdb_live', 'transfer_wpdb_live_to_staging')),

        'transfer_wpdb_live_to_local' => array('label' => 'to local server',
            'condition' => array('transfer', 'transfer_wp_db', 'transfer_wpdb_live')),
        'transfer_wpdb_live_to_local_db' => array('label' => 'Transfer DB',
            'condition' => array('transfer', 'transfer_wp_db', 'transfer_wpdb_live', 'transfer_wpdb_live_to_local')),
        'transfer_wpdb_live_to_local_options' => array('label' => 'Search-Replace DB URLs',
            'condition' => array('transfer', 'transfer_wp_db', 'transfer_wpdb_live', 'transfer_wpdb_live_to_local')),
        'transfer_wpdb_live_to_local_replace_urls' => array('label' => 'Set custom DB options',
            'condition' => array('transfer', 'transfer_wp_db', 'transfer_wpdb_live', 'transfer_wpdb_live_to_local')),

        'transfer_wpdb_staging' => array('label' => 'From staging',
            'condition' => array('transfer', 'transfer_wp_db')),
        'transfer_wpdb_staging_to_live' => array('label' => 'to live server',
            'condition' => array('transfer', 'transfer_wp_db', 'transfer_wpdb_staging')),
        'transfer_wpdb_staging_to_live_db' => array('label' => 'Transfer DB',
            'condition' => array('transfer', 'transfer_wp_db', 'transfer_wpdb_staging', 'transfer_wpdb_staging_to_live')),
        'transfer_wpdb_staging_to_live_replace_urls' => array('label' => 'Search-Replace DB URLs',
            'condition' => array('transfer', 'transfer_wp_db', 'transfer_wpdb_staging', 'transfer_wpdb_staging_to_live')),
        'transfer_wpdb_staging_to_live_options' => array('label' => 'Set custom DB options',
            'condition' => array('transfer', 'transfer_wp_db', 'transfer_wpdb_staging', 'transfer_wpdb_staging_to_live')),

        'transfer_wpdb_staging_to_local' => array('label' => 'to local server',
            'condition' => array('transfer', 'transfer_wp_db', 'transfer_wpdb_staging')),
        'transfer_wpdb_staging_to_local_db' => array('label' => 'Transfer DB',
            'condition' => array('transfer', 'transfer_wp_db', 'transfer_wpdb_staging', 'transfer_wpdb_staging_to_local')),
        'transfer_wpdb_staging_to_local_replace_urls' => array('label' => 'Search-Replace DB URLs',
            'condition' => array('transfer', 'transfer_wp_db', 'transfer_wpdb_staging', 'transfer_wpdb_staging_to_local')),
        'transfer_wpdb_staging_to_local_options' => array('label' => 'Set custom DB options',
            'condition' => array('transfer', 'transfer_wp_db', 'transfer_wpdb_staging', 'transfer_wpdb_staging_to_local')),

        'transfer_wpdb_local' => array('label' => 'From local',
            'condition' => array('transfer', 'transfer_wp_db')),
        'transfer_wpdb_local_to_live' => array('label' => 'to live server',
            'condition' => array('transfer', 'transfer_wp_db', 'transfer_wpdb_local')),
        'transfer_wpdb_local_to_live_db' => array('label' => 'Transfer DB',
            'condition' => array('transfer', 'transfer_wp_db', 'transfer_wpdb_local', 'transfer_wpdb_local_to_live')),
        'transfer_wpdb_local_to_live_replace_urls' => array('label' => 'Search-Replace DB URLs',
            'condition' => array('transfer', 'transfer_wp_db', 'transfer_wpdb_local', 'transfer_wpdb_local_to_live')),
        'transfer_wpdb_local_to_live_options' => array('label' => 'Set custom DB options',
            'condition' => array('transfer', 'transfer_wp_db', 'transfer_wpdb_local', 'transfer_wpdb_local_to_live')),

        'transfer_wpdb_local_to_staging' => array('label' => 'to staging server',
            'condition' => array('transfer', 'transfer_wp_db', 'transfer_wpdb_local')),
        'transfer_wpdb_local_to_staging_db' => array('label' => 'Transfer DB',
            'condition' => array('transfer', 'transfer_wp_db', 'transfer_wpdb_local', 'transfer_wpdb_local_to_staging')),
        'transfer_wpdb_local_to_staging_replace_urls' => array('label' => 'Search-Replace DB URLs',
            'condition' => array('transfer', 'transfer_wp_db', 'transfer_wpdb_local', 'transfer_wpdb_local_to_staging')),
        'transfer_wpdb_local_to_staging_options' => array('label' => 'Set custom DB options',
            'condition' => array('transfer', 'transfer_wp_db', 'transfer_wpdb_local', 'transfer_wpdb_local_to_staging'))
    );
